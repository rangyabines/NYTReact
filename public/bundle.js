					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'em',
								null,
								'Search for and annotate articles of intesrest.'
							)
						)
					),
					React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement("input", { type: "text", className: "form-control text-center", id: "term2", onChange: this.handleChange, required: true }),
							React.createElement("br", null),
							React.createElement(
								"h4",
								{ className: "" },
							...
							React.createElement("input", { type: "text", className: "form-control text-center", id: "term3", onChange: this.handleChange, required: true }),
							React.createElement("br", null),
							React.createElement(
								"button",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
		...
		runQuery: function runQuery(topic) {
			...
			//article search
			var queryURL = "https://api.nytimes.com/svc/search/v2/articlesearch.json?q=xyz" + topic + "&pretty=1&key=" + articleSearchAPI;
